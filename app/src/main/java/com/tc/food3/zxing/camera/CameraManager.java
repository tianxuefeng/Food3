...
package com.tc.food3.zxing.camera;
...
public final class CameraManager {
	...
	private int MIN_FRAME_WIDTH = 360;
	private int MIN_FRAME_HEIGHT = 360;
	...
	public static void init(Context context) {
		if (cameraManager == null) {
			...
			// cameraManager.MAX_FRAME_WIDTH = SP
		}
	}
	...
	/**
	 * Opens the camera light if still in use.
	 */
	...
	/**
	 * Closes the camera light if still in use.
	 */
